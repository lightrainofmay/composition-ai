...
def generate_common_prompt(text):
    return (
        "你是一个经验丰富的中学语文老师，请你阅读以下学生作文，并给出详细的指导：\n"
        "1. 请指出其中存在的标点符号、字词、语法错误；\n"
        "2. 从结构、逻辑、论点、论据等角度分析作文的优缺点；\n"
        "3. 给出详细的修改建议；\n"
        "4. 请根据上述评分要点，给这篇文章一个分数，分数范围在0-100之间。"
        "5. 最后，请根据原文内容，写出一篇经过修改的高质量范文，内容不少于300字。\n\n"
        f"学生作文如下：\n{text}"
    )
